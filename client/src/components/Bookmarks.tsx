...
const Bookmarks = ({
  ...
  return (
    <div className="flex flex-col gap-6 md:gap-10 px-4">
      {arrayBookmarked.length > 0 ? (
        <>
          <section className="text-white">
            <h2 className="mb-4 text-xl tracking-[-0.312px] md:text-[32px] md:mb-8 md:mt-9">
              Movies
            </h2>
            <div className="flex flex-wrap gap-[15px] md:gap-[29px] lg:gap-10">
              {data1.map(
                (items, index) =>
                  ...
                  items.category === "Movie" && (
                    ...
                    >
                      <img
                        className="rounded-lg max-w-[164px] md:max-w-[220px] lg:max-w-[280px] transition duration-300 lg:group-hover:scale-105 lg:group-hover:brightness-50"
                        src={images[index + 5]}
                        alt={index.toString()}
                      />
                      <div className="flex flex-col items-center absolute top-0 right-0 bottom-0 left-0">
                        ...
                        >
                          ...
                          <path
                            ...
                            strokeWidth="1.5"
                            fill={
                              arrayBookmarked.includes(index) ? "white" : "none"
                            }
                          />
                        </svg>
